...
:setvar DefaultDataPath "C:\Users\david\AppData\Local\Microsoft\VisualStudio\SSDT\JooleDataBase"
:setvar DefaultLogPath "C:\Users\david\AppData\Local\Microsoft\VisualStudio\SSDT\JooleDataBase"
...
GO
PRINT N'Creating Table [dbo].[tblSpecification]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_tblSpecification_tblProduct]...';


GO
ALTER TABLE [dbo].[tblSpecification] WITH NOCHECK
    ADD CONSTRAINT [FK_tblSpecification_tblProduct] FOREIGN KEY ([ProductID]) REFERENCES [dbo].[tblProduct] ([ProductID]);
...
GO
ALTER TABLE [dbo].[tblSpecification] WITH CHECK CHECK CONSTRAINT [FK_tblSpecification_tblProduct];
